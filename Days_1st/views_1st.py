		...
		if form.is_valid():
			...
			for i in range(1):
				...
				if (obj.second_date_with_total_lunar_eclipse.month == 1 and 
					...
					and abs(obj.second_date_with_total_lunar_eclipse.year-
			...
			td = timedelta(days=abs(res[0]*365 + res_2[0]+ (res_1[0]*4*7)))
			...
			obj.first_date_with_total_lunar_eclipse.year ==  
				...
				and obj.first_date_with_total_lunar_eclipse.month ==
				obj.second_date_with_total_lunar_eclipse.month):
			...
			obj.first_date_with_total_lunar_eclipse.year ==  
				obj.second_date_with_total_lunar_eclipse.year and 
			...
			obj.first_date_with_total_lunar_eclipse.year ==  
				...
				if  (obj.second_date_with_total_lunar_eclipse.month -
				obj.first_date_with_total_lunar_eclipse.month == 1):

					td = (timedelta(days=(30+(obj.second_date_with_total_lunar_eclipse.day-
						obj.first_date_with_total_lunar_eclipse.day))))

				elif (obj.second_date_with_total_lunar_eclipse.month -
				obj.first_date_with_total_lunar_eclipse.month > 1):

					

					td = (timedelta(days=(obj.second_date_with_total_lunar_eclipse.month - obj.first_date_with_total_lunar_eclipse.month ) * 30  - 

						(obj.first_date_with_total_lunar_eclipse.day - obj.second_date_with_total_lunar_eclipse.day)))
			...
			obj.first_date_with_total_lunar_eclipse.year ==  
				...
				obj.first_date_with_total_lunar_eclipse.month == 1):
					...
					td = (timedelta(days=abs((30-obj.first_date_with_total_lunar_eclipse.day-
						obj.second_date_with_total_lunar_eclipse.day))))
				...
				obj.first_date_with_total_lunar_eclipse.month > 1):
					...
					td = (timedelta(days=abs((obj.second_date_with_total_lunar_eclipse.month - obj.first_date_with_total_lunar_eclipse.month ) * 30  - 
			...
			obj.first_date_with_total_lunar_eclipse.year ==  
				...
				elif (obj.first_date_with_total_lunar_eclipse.month -
				obj.second_date_with_total_lunar_eclipse.month > 1):


					td = (timedelta(days=(abs(obj.first_date_with_total_lunar_eclipse.month - obj.second_date_with_total_lunar_eclipse.month ) * 30  - 

						(obj.second_date_with_total_lunar_eclipse.day - obj.first_date_with_total_lunar_eclipse.day))))
			...
			obj.first_date_with_total_lunar_eclipse.year ==  
				...
				obj.second_date_with_total_lunar_eclipse.month == 1):
					...
					td = (timedelta(days=(30+obj.first_date_with_total_lunar_eclipse.day-
						obj.second_date_with_total_lunar_eclipse.day)))
				...
				obj.second_date_with_total_lunar_eclipse.month > 1):
					...
					td = (timedelta(days=(obj.first_date_with_total_lunar_eclipse.month - obj.second_date_with_total_lunar_eclipse.month ) * 30  + 
			...
			obj.first_date_with_total_lunar_eclipse.month  and  
			...
			or abs(obj.first_date_with_total_lunar_eclipse.year - 
				obj.second_date_with_total_lunar_eclipse.year) == 1)
				...
				obj.first_date_with_total_lunar_eclipse.month > 1):
					...
					td = (timedelta(days=(res[0]*365 + (obj.second_date_with_total_lunar_eclipse.month - obj.first_date_with_total_lunar_eclipse.month ) * 30  - 
			...
			or abs(obj.first_date_with_total_lunar_eclipse.year - 
				...
				obj.first_date_with_total_lunar_eclipse.month == 1):
					...
					td = (timedelta(days=abs(res[0]*365 +( 30-obj.first_date_with_total_lunar_eclipse.day-
						obj.second_date_with_total_lunar_eclipse.day))))
				...
				obj.first_date_with_total_lunar_eclipse.month > 1):
					...
					td = (timedelta(days=abs(res[0]*365 +(obj.second_date_with_total_lunar_eclipse.month - obj.first_date_with_total_lunar_eclipse.month ) * 30  - 
			...
			or abs(obj.first_date_with_total_lunar_eclipse.year - 
				...
				obj.second_date_with_total_lunar_eclipse.month > 1):
					...
					td = (timedelta(days=(abs(res[0]*365 +(obj.first_date_with_total_lunar_eclipse.month - obj.second_date_with_total_lunar_eclipse.month ) * 30  - 
			...
			or abs(obj.first_date_with_total_lunar_eclipse.year - 
				...
				obj.second_date_with_total_lunar_eclipse.month == 1):
					...
					td = (timedelta(days=(res[0]*365 +(30+obj.first_date_with_total_lunar_eclipse.day-
						obj.second_date_with_total_lunar_eclipse.day))))
				...
				obj.second_date_with_total_lunar_eclipse.month > 1):
					...
					td = (timedelta(days=(res[0]*365 +(obj.first_date_with_total_lunar_eclipse.month - obj.second_date_with_total_lunar_eclipse.month ) * 30  + 
			...
			or abs(obj.first_date_with_total_lunar_eclipse.year - 
				...
				obj.first_date_with_total_lunar_eclipse.month == 1):
					...
					td = (timedelta(days=(res[0]*365 +(30+(obj.second_date_with_total_lunar_eclipse.day-
						obj.first_date_with_total_lunar_eclipse.day)))))
